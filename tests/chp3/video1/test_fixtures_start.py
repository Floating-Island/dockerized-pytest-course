...
def prepare_transform_data(map_data_location):
    population_dict = {
            'Andorra': 77142,
            'Argentina': 44780677,
            'Cape Verde': 546388,
...
def test_data_population_update(prepare_transform_data):
    """
    Happy Path test
    """
    data_to_transform, population_dict = prepare_transform_data
...
def test_data_population_no_update(prepare_transform_data):
    """
